...
data Q = Loud | Quiet deriving stock (Eq, Show)
data K = NoKey | IncludeKey deriving stock (Eq, Show)
type Key = ByteString
...
data SESet = SESet Flags Expiration deriving stock (Eq, Show)
data SEIncr = SEIncr Initial Delta Expiration deriving stock (Eq, Show)
data SETouch = SETouch Expiration deriving stock (Eq, Show)
